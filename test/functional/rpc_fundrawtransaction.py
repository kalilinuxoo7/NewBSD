...
class RawTransactionsTest(BitsendTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid bitsend address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
