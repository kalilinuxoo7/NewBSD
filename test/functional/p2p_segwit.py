...
class SegWitTest(BitsendTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, bitsendd delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bitsendd fill it in.
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older bitsendd's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-bitsendd> to
    # the test.
    def test_upgrade_after_activation(self, node_id):
        self.log.info("Testing software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active bitsendd
