...
# TestNode: A peer we use to send messages to bitsendd, and store responses.
...
class CompactBlocksTest(BitsendTestFramework):
    ...
    # This test actually causes bitsendd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitsendd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitsendd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitsendd will not send blocktxn responses for blocks whose height is
