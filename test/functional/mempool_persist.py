...
By default, bitsendd will dump mempool on shutdown and
...
class MempoolPersistTest(BitsendTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give bitsendd a second to reload the mempool
        ...
        self.log.debug("Prevent bitsendd from writing mempool.dat to disk. Verify that `savemempool` fails")
