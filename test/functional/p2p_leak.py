...
Also test that nodes that send unsupported service bits to bitsendd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if bitsendd ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(BitsendTestFramework):
