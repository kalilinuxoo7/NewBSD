...
This reimplements tests from the bitsendj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure bitsendd isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitsendd isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the bitsend code has custom code which does so);
