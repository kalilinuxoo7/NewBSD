...
class BIP66Test(BitsendTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitsendd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitsendd produces more specific reject
            # reasons.
