UNIX BUILD NOTES
====================
Some notes on how to build Bitsend Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile bitsend and the dependencies,
...
memory available when compiling Bitsend Core. On systems with less, gcc can be
...
**For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~bitsend/+archive/bitsend).
...
See the section "Disable-wallet mode" to build Bitsend Core without wallet.
...
`--with-incompatible-bdb` according to the [PKGBUILD](https://projects.archlinux.org/svntogit/community.git/tree/bitsend/trunk/PKGBUILD).
As mentioned above, when maintaining portability of the wallet between the standard Bitsend Core distributions and independently built
