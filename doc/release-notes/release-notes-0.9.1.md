Bitsend Core version 0.9.1 is now available from:

  https://bitsend.org/bin/0.9.1/
...
bitsendd from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Bitsend Core software:
