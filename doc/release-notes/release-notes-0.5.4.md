Bitsend version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitsend/files/Bitsend/bitsend-0.5.4/
...
http://gitorious.org/bitsend/bitsendd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitsend-Qt notifications under Growl 1.3.
Increase required age of Bitsend-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitsend properly when installing Bitsend-Qt over it. (Windows)
