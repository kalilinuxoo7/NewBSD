Bitsend Core version 0.14.1 is now available from:

  <https://bitsend.org/bin/bitsend-core-0.14.1/>
...
here:
[reducing-bitsendd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` bitsend-tx input verification (awemany, jnewbery)
