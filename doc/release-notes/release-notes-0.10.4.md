Bitsend Core version 0.10.4 is now available from:

  <https://bitsend.org/bin/bitsend-core-0.10.4/>
...
- #6953 `43c2789` Split bitsend-tx into its own package
- #6953 `dfe0d4d` Include bitsend-tx binary on Debian/Ubuntu
