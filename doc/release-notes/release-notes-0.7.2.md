Bitsend version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitsend/files/Bitsend/bitsend-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Bitsend-Qt to crash on Windows when exiting.
