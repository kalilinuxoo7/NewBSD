Bitsend-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitsend/files/Bitsend/bitsend-0.8.6/
...
- Fix Bitsend-Qt startup crash when clicking dock icon on OSX 
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/bitsend/bitsend.org/pull/279).
