Bitsend version 0.5.2 is now available for download at:
http://sourceforge.net/projects/bitsend/files/Bitsend/bitsend-0.5.2/
...
http://gitorious.org/bitsend/bitsendd-stable/archive-tarball/v0.5.2#.tar.gz
