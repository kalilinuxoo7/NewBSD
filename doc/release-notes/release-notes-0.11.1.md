Bitsend Core version 0.11.1 is now available from:

  <https://bitsend.org/bin/bitsend-core-0.11.1/>
...
(see https://github.com/bitsend/bitsend/pull/6795).
...
one was randomly violated by all deployed bitsend software prior to
...
Bitsend Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Bitsendj has done so for a similar span of time.
Bitsendjs and electrum have been more recently updated.
...
[1] On the Malleability of Bitsend Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/bitsend/paper_9.pdf
...
(see https://github.com/bitsend/bitsend/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libbitsendconsensus: avoid a crash in multi-threaded environments
