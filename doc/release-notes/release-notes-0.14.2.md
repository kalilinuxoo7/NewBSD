Bitsend Core version 0.14.2 is now available from:

  <https://bitsend.org/bin/bitsend-core-0.14.2/>
...
(in Bitsend Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Bitsend-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitsend-config.h as necessary (theuni)
